...
export class VectorStorageController {
  ...
  async getStorageDetail(@Param('id') id: string) {
    try {
  ...
  async getStorageItems(@Param('id') id: string) {
    try {
  ...
  async updateStorage(@Param('id') id: string, @Body() body: Partial<FormStorageDto>) {
    try {
  ...
  async deleteStorage(@Param('storageId') storageId: string) {
    try {
  ...
  upload(@UploadedFile() file: Express.Multer.File, @Param('id') storageId: string) {
    try {
  ...
  async deleteStorageItem(@Param('storageId') storageId: string, @Param('itemId') itemId: string) {
    try {
